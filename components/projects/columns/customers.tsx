...
import { createTextColumn, createUserEmailColumn, createVillageNameColumn, createCustomerFactoryIdColumn, createCustomerFactoryNameColumn, createVillageIdColumn } from "./helpers"
...
export function getCustomersColumns<T>(): ColumnDef<T>[] {
  return [
    ...
    createCustomerFactoryIdColumn(),
    createCustomerFactoryNameColumn(),
  ]
}
