...
/**
 * @file components/projects/filters/factories.tsx
 * @description Filter controls for the Factories entity table.
 */
...
interface FactoriesFiltersProps<TData> {
  table: Table<TData>
}

export function FactoriesFilters<TData>({ table }: FactoriesFiltersProps<TData>) {
