export default [
  {
    ...
    difficulty: "Easy",
    portion: "Serves 4",
    time: "Hands-on time 40 min, plus cooling",
    description:
  ...
  },
  {
    ...
    difficulty: "Easy",
    portion: "Serves 4, or 6 with other side dishes",
    ...
    ingredients: [
      "2 lap cheong (Chinese wind-dried sausage; available from Asian supermarkets or souschef.co.uk)",
      ...
      "1 tbsp crispy chilli oil or toasted sesame oil, plus extra to serve",
      "Bamboo steamer",
    ],
    method: [
      {
        "Step 1":
          "Set a bamboo steamer over a pan of simmering water and a large non-stick wok (ideally carbon steel) over a high heat.",
      },
      {
        "Step 2":
  ...
  },
  {
    ...
    difficulty: "Easy",
    portion: "Serves 3-4 as part of a meal",
    time: "Hands-on time 45 min, plus marinating",
    description:
  ...
  },
  {
    ...
    difficulty: "Easy",
    portion: "Makes 20 dumplings (serves 2 as a meal or 3-4 as a snack)",
    time: "Hands-on time 40 minutes",
    description:
    ...
    ingredients: [
      "150g plain flour",
      "100ml boiling waterFor the filling ",
  ...
  },
  {
    ...
    difficulty: "Easy",
    portion: "Serves 2-4 as part of a meal",
    time: "Hands-on time 30 min, oven time 15 min",
    description:
  ...
  },
  {
    ...
    difficulty: "Easy",
    portion: "Serves 2 as a main or 4 as a side",
    ...
    method: [
      {
        "Step 1":
          "For the pak choi, put a heatproof plate inside a steamer with the pak choi on it. Season with salt, rice wine, tamari/light soy sauce and sesame oil, then lay the ginger slices over the top. Put the lid on the steamer, bring to the boil, then gently steam over a low heat for 3-4 minutes.",
      },
      {
        "Step 2":
          "Meanwhile, in a small jug or cup, mix the cornflour with 2 tbsp water to create a paste. Put a wok or deep frying pan over a high heat and add the rapeseed oil. When it starts to smoke, add the garlic, ginger and chillies and stir-fry for a few seconds, then add the black beans and yellow bean or miso paste and stir quickly.",
      },
      {
        "Step 3":
          "Add the tofu and stir-fry for 1 minute, keeping the ingredients moving in the wok, then add the rice wine or sherry and the peppers and stir-fry for a further minute.",
      },
      {
        "Step 4":
          "Add the stock and bring to the boil. Season with the tamari or soy sauce, then add the cornflour paste and stir to thicken. Serve the tofu alongside the pak choi and jasmine rice.",
      },
    ],
  ...
  },
  {
    ...
    difficulty: "Easy",
    portion: "Serves 4",
    time: "Hands-on time 30 min, plus soaking",
    description:
  ...
  },
  {
    ...
    method: [
      ...
      {
        "Step 5":
          "Return the tofu to the pan and toss to coat all over. Serve with extra chilli, steamed rice and broccoli.",
      },
    ],
  ...
  },
  {
    ...
    difficulty: "Easy",
    portion: "Makes 12",
    time: "Hands-on time 30 min, cooking time 5-10 min",
    description:
      "These super-simple sweet chilli spring rolls tick the \u2018dirty vegan\u2019 box \u2013 even avowed meat eaters will be reaching for more\u2026",
    ingredients: [
  ...
  },
  {
    ...
    difficulty: "Medium",
    portion: "Serves 4-6 as part of a sharing menu",
    time: "Hands-on time 20 min, steaming time 15-18 min",
    description:
  ...
  },
  {
    ...
    difficulty: "Easy",
    portion: "Serves 4-6 as part of a sharing menu",
    time: "Hands-on time 10 min, steaming time 25 min, plus marinating",
    description:
