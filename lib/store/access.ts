...
export const RBAC_MATRIX: Record<Role, Record<ProjectSlug, Permission>> = {
  [Role.SUPER_ADMIN]: {
    ...
    [ProjectSlug.OPERATORS]: { read: true, write: true, delete: true },
    ...
    [ProjectSlug.COMMODITY_PRICES]: { read: true, write: true, delete: true },
  ...
  [Role.MANAGER]: {
    [ProjectSlug.USERS]: { read: false, write: false, delete: false },
    [ProjectSlug.OPERATORS]: { read: true, write: true, delete: false },
    [ProjectSlug.VILLAGES]: { read: true, write: false, delete: false },
    [ProjectSlug.FACTORIES]: { read: true, write: false, delete: false },
    [ProjectSlug.CENTERS]: { read: true, write: false, delete: false },
    [ProjectSlug.COMMODITIES]: { read: true, write: false, delete: false },
    [ProjectSlug.COMMODITY_PRICES]: { read: true, write: true, delete: false },
    [ProjectSlug.CUSTOMERS]: { read: true, write: true, delete: false },
    [ProjectSlug.WEIGHMENTS]: { read: true, write: true, delete: false },
  },
  [Role.OPERATOR]: {
    [ProjectSlug.USERS]: { read: false, write: false, delete: false },
    [ProjectSlug.OPERATORS]: { read: false, write: false, delete: false },
    [ProjectSlug.VILLAGES]: { read: true, write: false, delete: false },
    [ProjectSlug.FACTORIES]: { read: true, write: false, delete: false },
    [ProjectSlug.CENTERS]: { read: true, write: false, delete: false },
    [ProjectSlug.COMMODITIES]: { read: true, write: false, delete: false },
    [ProjectSlug.COMMODITY_PRICES]: { read: true, write: false, delete: false },
    [ProjectSlug.CUSTOMERS]: { read: true, write: true, delete: false },
    [ProjectSlug.WEIGHMENTS]: { read: true, write: true, delete: false },
  },
  [Role.BASE]: {
    ...
    [ProjectSlug.COMMODITY_PRICES]: { read: false, write: false, delete: false },
