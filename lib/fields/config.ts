...
export const PROJECT_FIELDS: Record<string, FieldConfig[]> = {
  ...
  [ProjectSlug.CUSTOMERS]: [
    ...
    { key: EntityKey.ID, label: ColumnLabel.ID, placeholder: "Select user...", type: FieldType.TEXT, icon: Hash },
  ...
  [ProjectSlug.WEIGHMENTS]: [
    ...
    { key: EntityKey.RATE_ID, label: ColumnLabel.RATE_ID, placeholder: "e.g. 1", type: FieldType.TEXT, icon: Package },
    { key: EntityKey.CENTER_ID, label: ColumnLabel.CENTER_ID, placeholder: "e.g. 1", type: FieldType.TEXT, icon: Building },
    {
