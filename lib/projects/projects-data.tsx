...
export const PROJECTS: ProjectMetadata[] = [
  ...
  { slug: ProjectSlug.DATA_ENTRIES, name: ProjectName.DATA_ENTRIES, desc: "Input logs, sheets and record metrics", icon: ClipboardList, color: "text-purple-500" },
  ...
  { slug: ProjectSlug.OPERATORS, name: ProjectName.OPERATORS, desc: "Manage workers and field operatives", icon: UserCog, color: "text-pink-500" },
